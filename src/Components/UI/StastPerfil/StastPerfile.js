...
import { Dimensions, View, StyleSheet, Text, Image, ActivityIndicator } from "react-native"
import { Card, Avatar } from "react-native-elements"
import StasPerfil from "./StastPerfil"
import StastDescripcion from "./StastDescripcion"
...
const StastPerfile = ({
    ...
    const data = [{ userName: "RedArt", nickName: "levde", pensamiento: "el mejor", corriente: "abstracta", edad: "21" }]
    const [fonstLoaded, setFonstLoaded] = useState(false)
    const { state: perfilData, getPerfile } = useContext(perfileContext)
    ...
    if (!fonstLoaded || !(perfilData.perfiles[0] && true)) {
        return (
    ...
    rounded
    size="large"
    containerStyle={Style.containerAva}
    source={{ uri: `data:image/jpg;base64,${perfilData.perfiles[0].image.base64}` }}
/>*/
    ...
    return (
        <>
            ...
            <View style={Style.CardConteiner}>
                ...
                <View style={Style.Container}>
                    ...
                    <View style={Style.conteinerPerfil}>
                        <Text style={Style.Text1}>
                            {perfilData.perfiles[0].userName}
                        </Text>

                        <Text style={Style.Text2}>
                            {perfilData.perfiles[0].mystate}
                        </Text>
                ...
                <StastDescripcion perfiles={perfilData.perfiles} callback={callback} />
            </View>
        </>
...
export default StastPerfile


/* <Image
                    style={Style.Imagen}
                    source={{ uri: require('../../../assets/pintora.jpg') }}
                /> */